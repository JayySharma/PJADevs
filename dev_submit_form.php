<html lang="en" dir="ltr">
  ...
  <style>
      body{ background-color: rgb(216, 234, 235); }
  </style>
  <body>
    ...
    ?>
    <br>
    <a href="https://collegeprojectsem5.000webhostapp.com/" class="button">Return to Mall</a>
    <br>
    <a href="https://collegeprojectsem5.000webhostapp.com/dev_index.html" class="button">Return to MovieCenter</a>
    
    <style>
        .button{
            border-radius: 10%;
            background-color: rgb(209, 206, 44);
            padding: 5px;
            font-weight: bold;
            margin: 5px;
